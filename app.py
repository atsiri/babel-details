...
# tab1, tab2 = st.tabs(["WIUP Map Data", "Profile Network Data"])

# with tab1:
#     st.write("Detailed WIUP Area Data (filtered):")
#     # Drop geometry column for clean tabular viewing
#     display_gdf = filtered_gdf.drop(columns=['geometry', 'GEOMETRY'])
#     st.dataframe(display_gdf, use_container_width=True)

# with tab2:
#     st.write("Detailed Company & Individual Profile Data:")
#     # Filter profile data based on map selection or sidebar
#     profile_view = df_profile.copy()
#     if clicked_company:
#         profile_view = profile_view[profile_view['NAMA_PERUSAHAAN'] == clicked_company]
